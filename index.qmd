...
![](images/intro_grad.jpg)
:::

::: {.column .medium width="50%"}
![](images/intro_burnout.jpg)
:::
:::
...
## STEP 3: Build the card
- Used `coord_cartesian` instead of `xlim` and `ylim` to change range of x and y values plotted
- `coord_cartesian` doesn't throw out points or areas out of range
```{r, echo=T, eval=T}
xmas_ggplot <- xmas_ggplot + 
...
# These two lessons are valid

# But,... not as important as this one...

## 3. Be true to yourself

-   Remember to have fun with whatever you do!
