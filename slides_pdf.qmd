...
## Since get my MS in Stats, I was slowly losing my R knowledge

::: columns
::: {.column .medium width="50%"}
![](images/intro_grad.jpg){width="50%"}
:::

::: {.column .medium width="50%"}
![](images/intro_burnout.jpg){width="50%"}
:::
:::
:::
...
![](images/intro_xmas_conf.jpg){width="50%"}
...
![](images/design_step1_holiday_card_draft.jpg){width="50%"}
:::
:::
...
![](images/step2_pick_ggplot2.png){width="50%"}
...
-   With plotting any `ggplot2` object
    -   First, find the right `ggplot2` function to plot what you want
    -   Next, set up some data points that work with it
    -   Then, plot and adjust output through `ggplot2` object parameters (ie.., `size`, `color`, etc)
...
-   Used `coord_cartesian` to zoom in where tree is without throwing out points
out of range
...
![](images/step3_snowman_as_image.png){.image-center}

\newpage
## STEP 3: Build the card

-   Building the snowman's head, chest, torso involves the same set of steps used for the tree
-   Ex. First, find a function to fit your plotting needs
-   I.e., `geom_point` for three oversized points for snowman's body

\newpage
## STEP 3: Build the card

Set up coordinates for where parts of the body will be
...
-   Then, plot them
-   Make aesthetic changes if needed (i.e., size, color)
...
-   Repeat aforementioned pattern of steps for other parts of the snowman
-   I.e., eyes, nose, mouth, chest buttons, arms
...
\newpage
## 1. I learned more about the `ggplot2` library

-   New functions like `geom_ribbon()`
-   How the grammar of graphics works
-   More practice with data viz

\newpage
## 2. Honed in my process for better project management

-   Knowing my why
-   Creating a vision of the outcome
-   Researching methods to achieve it
-   Execution
...
-   Not everyone learns or thinks the same way
-   Everyone has a unique spark that makes them special
-   So always believe that your perspective matters...

\newpage
## Because you KEN do it!
...
Mastodon:[\@kenvu777](https://fosstodon.org/@kenvu777)

LinkedIn: [linkedin.com/in/kenvu1](https://www.linkedin.com/in/kenvu1)

Github: [@Ken-Vu](https://github.com/Ken-Vu)

This Presentation's Github Repo: [Slides](https://github.com/Ken-Vu/making_xmas_card_ggplot2)
:::

::: {.column width="50%"}
Scan to see all my links:
![](images/QR_code_LinktoKensLinktree.png){width="60%"}
:::
:::
